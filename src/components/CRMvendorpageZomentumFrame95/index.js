...
export const CRMvendorpageZomentumFrame95 = (props) => {
  return (
    <Column className={`  ${props?.className} `}>
      ...
      <Text className="3xl:mt-[28px] 3xl:text-fs19 font-circularstd font-normal leading-lh27 lg:mt-[18px] lg:text-fs12 mt-[24px] self-stretch text-colors1 text-fs16 text-left tracking-ls1 w-[100%] xl:mt-[21px] xl:text-fs14">
        {props?.children1}
      </Text>
...
CRMvendorpageZomentumFrame95.defaultProps = {
  children: "",
  children1: "",
  children2: "",
  src: "img_rightmenuarro_2.svg",
  alt: "RightmenuArro",
};
